            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-sm-9" id="content">         
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2 text-right">
                                    <div class="button-view">
                                        <a  class="active" id="list-view" href="product-list.php"><i class="fa fa-th-list"></i></a>
                                        <a  id="grid-view" href="product.php"><i class="fa fa-th"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row product-gallery-list-block">
